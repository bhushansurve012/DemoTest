...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #3498DB; height:95px;">
   <a class="navbar-brand" href="#" style="margin-top:40px;">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/NTT-Data-Logo.svg/1024px-NTT-Data-Logo.svg.png" width="30" height="30" class="d-inline-block align-top" alt="">
    Bootstrap
  </a>
