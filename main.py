...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #3498DB; height:95px;">
   <a class="navbar-brand" href="#" style="margin-top:30px;">
    <img href="https://www.google.com/url?sa=i&url=https%3A%2F%2Fcommons.wikimedia.org%2Fwiki%2FFile%3ANTT-Data-Logo.svg&psig=AOvVaw1gpwR_QHouaxD3fEZ4QyQb&ust=1692694448036000&source=images&cd=vfe&opi=89978449&ved=0CBAQjRxqFwoTCMDl_qyw7YADFQAAAAAdAAAAABAE" width="30" height="30" class="d-inline-block align-top" alt="">
    Bootstrap
  </a>
